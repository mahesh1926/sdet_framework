...
public class TC_45_oppertunityWithSearchNotContainsTest extends baseclass {
...
@Test
	...
	//click on oppertunity link
		...
		String option=eutil.getExcelTestData("sheet1", 7, 2);
	homepage =new HomePage(driver);
	homepage.clickonoppertunitiesLink();
	...
	Assert.assertFalse(actualvalue.contains(input));
