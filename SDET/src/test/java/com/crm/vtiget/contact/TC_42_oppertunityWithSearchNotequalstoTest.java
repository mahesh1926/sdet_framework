...
public class TC_42_oppertunityWithSearchNotequalstoTest extends baseclass {
...
@Test
	...
	//click on oppertunity link
		String option=eutil.getExcelTestData("sheet1", 4, 2);
	homepage =new HomePage(driver);
	homepage.clickonoppertunitiesLink();
	...
	Assert.assertNotEquals(actualvalue, input);
